...
namespace NewtonVR
{
    public abstract class NVRInteractable : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
			...
			//TODO ALTSPACE: adjust drop distance globally, needed for 2d/gear because of fixed player height
	        DropDistance = 1.5f;
        ...
        protected virtual void FixedUpdate()
        {
            if (IsAttached == true)
            {
                ...
                {
					//TODO ALTSPACE: no more dropping based on distance- instead just teleport the object over
//                    DroppedBecauseOfDistance();
					AttachedHand.CurrentlyInteracting.transform.position = AttachedHand.transform.position;
				}
			}
        }
