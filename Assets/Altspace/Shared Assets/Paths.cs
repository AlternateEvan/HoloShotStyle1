...
public static class Paths {
	...
	public static string StartupSettings = Path.Combine(Desktop, "startup_settings.json");

	public static string StartupSettingsBackup = Path.Combine(Desktop, "startup_settings.json.backup");
}
