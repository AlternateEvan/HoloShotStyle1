...
namespace Amazon.S3.Util
{
    ...
    public class PostObjectRequest : AmazonWebServiceRequest
    {
        ...
        /// <summary>
        /// S3 Bucket to UploadAndPublishAssetBundle the object to
        /// </summary>
        ...
        /// <summary>
        /// Stream to read the UploadAndPublishAssetBundle data for
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// File path to read the UploadAndPublishAssetBundle data from
        /// </summary>
        ...
        /// <summary>
        /// Where to redirect browsers on a successful UploadAndPublishAssetBundle
        /// </summary>
        public string SuccessActionRedirect { get; set; }

        /// <summary>
        /// The status code returned to the client upon successful UploadAndPublishAssetBundle if success_action_redirect is not specified
        /// </summary>
        /// <remarks>
        /// <para>
